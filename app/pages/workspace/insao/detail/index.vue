					...
					<view style="min-height: 34vh">
						<uni-table ref="table"  border stripe emptyText="暂无更多数据">
							<uni-tr>
								...
								<uni-th width="90" align="center">物品类别</uni-th>
								<uni-th width="150" align="center">溯源码</uni-th>
								<uni-th width="150" align="center">录入情况</uni-th>
							</uni-tr>
							<uni-tr v-for="(item, index) in dataList" :key="index">
								...
								<uni-td align="center">{{ item.snCode}}</uni-td>
								<uni-td align="center" v-if="item.scanSuccess==true">录入完成</uni-td>
								<uni-td align="center" v-else>
									<button size="mini" type="primary" @click="changeInGoodsList(item)">确认入库</button>
								</uni-td>
							</uni-tr>
						</uni-table>
					</view>
			...
			return {
				...
				column: [{
					...
					// }, 
					{
						...
						filters: {
							true: '已录入',
							null: {type:'operation',align: "center",renders:[
						  {
							name:'编辑',
