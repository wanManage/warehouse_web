<template>
	<view>
		<cu-custom bgColor="bg-cyan">
			<block slot="content">HengSay仓储</block>
		</cu-custom>
		...
		data() {
			return {
				...
				serviceList: [{
						...
						permissions: true,
						permissionsKey: 'warehouse:inreceipt:approve'
					}, {
						icon: "/static/workspace/out-examine.png",
						title: '出库审核',
						path: "/pages/workspace/outexamine/index",
						permissions: false,
						permissionsKey: 'warehouse:outreceipt:approve'
					},
					{
					...
					// },
					{
						...
						permissions: true,
						permissionsKey: 'warehouse:apply:index'
					},
					// {
				...
				reportList: [{
					...
					permissions: true,
					permissionsKey: 'warehouse:warehousestock:query'
				}],
				loginShow: false,
				informations: [],
				records: 0,
