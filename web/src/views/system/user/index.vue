  ...
  <div class="app-container">
            ...
            <template slot-scope="scope" v-if="scope.row.userId !== 1">
              ...
              <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)" v-hasPermi="['system:user:resetPwd', 'system:user:edit']">
                ...
                <el-dropdown-menu slot="dropdown">
                  ...
                  <el-dropdown-item command="handleWarehouse" icon="el-icon-s-home" v-hasPermi="['system:user:edit']">分配仓库</el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
            </template>
          </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="50%" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="创建个人仓库">
              <el-radio-group v-model="form.hasWarehouse">
...
export default {
  ...
  methods: {
    ...
    handleCommand(command, row) {
      switch (command) {
        ...
        case "handleAuthRole":
          ...
          break;
        case "handleWarehouse":
          this.handleWarehouse(row);
          break;
        default:
          break;
      }
    ...
    handleWarehouse(row) {
      ...
      this.$router.push("/system/user-auth/warehouse/" + userId);
    },
    /** 重置密码按钮操作 */
    handleResetPwd(row) {
