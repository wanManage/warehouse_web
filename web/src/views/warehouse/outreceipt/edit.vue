      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="出库类别" prop="outWarehouseType">
          <el-radio-group v-model="form.outWarehouseType">
            <el-radio-button v-if="dict.value != 99 && dict.value != 65" v-for="dict in dict.type.outreceipt_type" :key="dict.value" :label="dict.value" :value="dict.value">{{ dict.label }}</el-radio-button>
          </el-radio-group>
        </el-form-item>
