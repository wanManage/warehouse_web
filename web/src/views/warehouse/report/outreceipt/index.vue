    ...
    <el-table v-loading="loading" :data="outreceiptList">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="text" icon="el-icon-camera-solid" v-if="scope.row.state >= 3" @click="handleView(scope.row)" v-hasPermi="['warehouse:outreceipt:query']">打印</el-button>
          <el-button size="mini" type="text" icon="el-icon-s-check" v-if="scope.row.state == 2" @click="handleApprove(scope.row)" v-hasPermi="['warehouse:outreceipt:approve']">审核</el-button>
