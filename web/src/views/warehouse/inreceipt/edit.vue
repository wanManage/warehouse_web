  ...
  <div class="app-container">
    <el-card>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="入库类别" prop="inWarehouseType" disabled>
          <el-radio-group v-model="form.inWarehouseType" >
            <el-radio-button v-if="dict.value != 98 && dict.value != 66" v-for="dict in dict.type.inreceipt_type" :key="dict.value" :label="dict.value" :value="dict.value">{{ dict.label }}</el-radio-button>
          </el-radio-group>
        </el-form-item>
