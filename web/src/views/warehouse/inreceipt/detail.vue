  ...
  <div class="app-container">
    <el-card>
      <div slot="header" class="clearfix">
        ...
        <el-button style="float: right; margin-left: 10px" icon="el-icon-s-check" type="danger" v-if="form.state == 2" v-hasPermi="['warehouse:inreceipt:approve']" @click="rejectInReceipt">拒绝</el-button>
        <el-button style="float: right; margin-left: 10px" icon="el-icon-s-check" type="primary" v-if="form.state == 2" v-hasPermi="['warehouse:inreceipt:approve']" @click="approveInReceipt">审核</el-button>
      </div>
    ...
    <el-card>
      ...
      <el-table row-key="goodsId.id" lazy :load="load()" :tree-props="{children: 'children', hasChildren: true}"
      :data="receiptGoodsList" @selection-change="handleSelectionChange">
